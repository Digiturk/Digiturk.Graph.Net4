...
namespace Microsoft.Graph
{
    ...
    public static class DriveItemRequestBuilderExtensions
    {
        ...
        {
            var x = obj.GetType().BaseType.Assembly;

            var field = obj.GetType()
                            .BaseType
                            .GetFields(BindingFlags.NonPublic | BindingFlags.Instance)
                            .FirstOrDefault(_field => _field.FieldType == typeof(IRequestAdapter));
        ...
        private static Dictionary<string, object> GetPathParameters(this object obj)
        {
            var field = obj.GetType()
                .BaseType
                .GetFields(BindingFlags.NonPublic | BindingFlags.Instance)
                .FirstOrDefault(_field => _field.FieldType == typeof(Dictionary<string, object>));
        ...
        private static string GetUrlTemplate(this object obj)
        {
            var field = obj.GetType()
                .BaseType
                .GetFields(BindingFlags.NonPublic | BindingFlags.Instance)
                .FirstOrDefault(_field => _field.FieldType == typeof(string));
