...
SubjectRightsRequestSiteLocation result;
switch (mappingValue)
{
    case "#microsoft.graph.subjectRightsRequestAllSiteLocation":
        result = new SubjectRightsRequestAllSiteLocation();
        break;
    case "#microsoft.graph.subjectRightsRequestEnumeratedSiteLocation":
        result = new SubjectRightsRequestEnumeratedSiteLocation();
        break;
    default:
        result = new SubjectRightsRequestSiteLocation();
        break;
}
return result;
