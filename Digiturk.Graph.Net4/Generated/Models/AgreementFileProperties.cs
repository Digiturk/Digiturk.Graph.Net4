...
#nullable restore
        ...
        public static new AgreementFileProperties CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            ...
            if(mappingValue == "#microsoft.graph.agreementFile")
            {
                return new AgreementFile();
            }
            else if(mappingValue == "#microsoft.graph.agreementFileLocalization")
            {
                return new AgreementFileLocalization();
            }
            else if(mappingValue == "#microsoft.graph.agreementFileVersion")
            {
