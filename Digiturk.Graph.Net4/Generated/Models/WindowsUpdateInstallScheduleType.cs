...
WindowsUpdateInstallScheduleType result;
switch (mappingValue)
{
    case "#microsoft.graph.windowsUpdateActiveHoursInstall":
        result = new WindowsUpdateActiveHoursInstall();
        break;
    case "#microsoft.graph.windowsUpdateScheduledInstall":
        result = new WindowsUpdateScheduledInstall();
        break;
    default:
        result = new WindowsUpdateInstallScheduleType();
        break;
}
return result;
