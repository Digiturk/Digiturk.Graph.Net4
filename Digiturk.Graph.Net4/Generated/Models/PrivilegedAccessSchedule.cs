...
PrivilegedAccessSchedule result;
switch (mappingValue)
{
    case "#microsoft.graph.privilegedAccessGroupAssignmentSchedule":
        result = new PrivilegedAccessGroupAssignmentSchedule();
        break;
    case "#microsoft.graph.privilegedAccessGroupEligibilitySchedule":
        result = new PrivilegedAccessGroupEligibilitySchedule();
        break;
    default:
        result = new PrivilegedAccessSchedule();
        break;
}
return result;
