...
#nullable restore
        ...
        public static new Attachment CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            ...
            if(mappingValue == "#microsoft.graph.fileAttachment")
            {
                return new FileAttachment();
            }
            else if(mappingValue == "#microsoft.graph.itemAttachment")
            {
                return new ItemAttachment();
            }
            else if(mappingValue == "#microsoft.graph.referenceAttachment")
            {
