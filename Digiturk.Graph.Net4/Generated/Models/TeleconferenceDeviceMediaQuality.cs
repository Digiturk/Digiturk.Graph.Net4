...
TeleconferenceDeviceMediaQuality result;
switch (mappingValue)
{
    case "#microsoft.graph.teleconferenceDeviceAudioQuality":
        result = new TeleconferenceDeviceAudioQuality();
        break;
    case "#microsoft.graph.teleconferenceDeviceScreenSharingQuality":
        result = new TeleconferenceDeviceScreenSharingQuality();
        break;
    case "#microsoft.graph.teleconferenceDeviceVideoQuality":
        result = new TeleconferenceDeviceVideoQuality();
        break;
    default:
        result = new TeleconferenceDeviceMediaQuality();
        break;
}
return result;
