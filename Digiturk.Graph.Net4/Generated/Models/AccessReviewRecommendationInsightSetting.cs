...
#nullable restore
        ...
        public static AccessReviewRecommendationInsightSetting CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            ...
            if(mappingValue == "#microsoft.graph.groupPeerOutlierRecommendationInsightSettings")
            {
                return new GroupPeerOutlierRecommendationInsightSettings();
            }
            else if(mappingValue == "#microsoft.graph.userLastSignInRecommendationInsightSetting")
            {
