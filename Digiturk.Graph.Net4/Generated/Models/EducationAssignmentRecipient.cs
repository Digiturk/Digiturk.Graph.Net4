...
#nullable restore
        ...
        public static EducationAssignmentRecipient CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            ...
            EducationAssignmentRecipient result;
switch (mappingValue)
{
    case "#microsoft.graph.educationAssignmentClassRecipient":
        result = new EducationAssignmentClassRecipient();
        break;
    case "#microsoft.graph.educationAssignmentGroupRecipient":
        result = new EducationAssignmentGroupRecipient();
        break;
    case "#microsoft.graph.educationAssignmentIndividualRecipient":
        result = new EducationAssignmentIndividualRecipient();
        break;
    default:
        result = new EducationAssignmentRecipient();
        break;
}
return result;
