...
TeamworkNotificationRecipient result;
switch (mappingValue)
{
    case "#microsoft.graph.aadUserNotificationRecipient":
        result = new AadUserNotificationRecipient();
        break;
    case "#microsoft.graph.channelMembersNotificationRecipient":
        result = new ChannelMembersNotificationRecipient();
        break;
    case "#microsoft.graph.chatMembersNotificationRecipient":
        result = new ChatMembersNotificationRecipient();
        break;
    case "#microsoft.graph.teamMembersNotificationRecipient":
        result = new TeamMembersNotificationRecipient();
        break;
    default:
        result = new TeamworkNotificationRecipient();
        break;
}
return result;
