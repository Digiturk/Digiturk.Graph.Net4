...
SubjectRightsRequestMailboxLocation result;
switch (mappingValue)
{
    case "#microsoft.graph.subjectRightsRequestAllMailboxLocation":
        result = new SubjectRightsRequestAllMailboxLocation();
        break;
    case "#microsoft.graph.subjectRightsRequestEnumeratedMailboxLocation":
        result = new SubjectRightsRequestEnumeratedMailboxLocation();
        break;
    default:
        result = new SubjectRightsRequestMailboxLocation();
        break;
}
return result;
