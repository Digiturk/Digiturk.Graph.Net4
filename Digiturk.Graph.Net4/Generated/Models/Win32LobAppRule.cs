...
Win32LobAppRule result;
switch (mappingValue)
{
    case "#microsoft.graph.win32LobAppFileSystemRule":
        result = new Win32LobAppFileSystemRule();
        break;
    case "#microsoft.graph.win32LobAppPowerShellScriptRule":
        result = new Win32LobAppPowerShellScriptRule();
        break;
    case "#microsoft.graph.win32LobAppProductCodeRule":
        result = new Win32LobAppProductCodeRule();
        break;
    case "#microsoft.graph.win32LobAppRegistryRule":
        result = new Win32LobAppRegistryRule();
        break;
    default:
        result = new Win32LobAppRule();
        break;
}
return result;
