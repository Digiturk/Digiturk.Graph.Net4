...
#nullable restore
        ...
        public static AccessReviewScope CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            ...
            if(mappingValue == "#microsoft.graph.accessReviewInactiveUsersQueryScope")
            {
                return new AccessReviewInactiveUsersQueryScope();
            }
            else if(mappingValue == "#microsoft.graph.accessReviewQueryScope")
            {
                return new AccessReviewQueryScope();
            }
            else if(mappingValue == "#microsoft.graph.principalResourceMembershipsScope")
            {
