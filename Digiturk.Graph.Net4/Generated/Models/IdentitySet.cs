...
switch (mappingValue)
{
    case "#microsoft.graph.chatMessageFromIdentitySet":
        result = new ChatMessageFromIdentitySet();
        break;
    case "#microsoft.graph.chatMessageMentionedIdentitySet":
        result = new ChatMessageMentionedIdentitySet();
        break;
    case "#microsoft.graph.chatMessageReactionIdentitySet":
        result = new ChatMessageReactionIdentitySet();
        break;
    case "#microsoft.graph.communicationsIdentitySet":
        result = new CommunicationsIdentitySet();
        break;
    case "#microsoft.graph.sharePointIdentitySet":
        result = new SharePointIdentitySet();
        break;
    default:
        result = new IdentitySet();
        break;
}
return result;
