...
WindowsInformationProtectionApp result;
switch (mappingValue)
{
    case "#microsoft.graph.windowsInformationProtectionDesktopApp":
        result = new WindowsInformationProtectionDesktopApp();
        break;
    case "#microsoft.graph.windowsInformationProtectionStoreApp":
        result = new WindowsInformationProtectionStoreApp();
        break;
    default:
        result = new WindowsInformationProtectionApp();
        break;
}
return result;
