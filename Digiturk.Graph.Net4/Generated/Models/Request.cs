...
switch (mappingValue)
{
    case "#microsoft.graph.privilegedAccessGroupAssignmentScheduleRequest":
        result = new PrivilegedAccessGroupAssignmentScheduleRequest();
        break;
    case "#microsoft.graph.privilegedAccessGroupEligibilityScheduleRequest":
        result = new PrivilegedAccessGroupEligibilityScheduleRequest();
        break;
    case "#microsoft.graph.privilegedAccessScheduleRequest":
        result = new PrivilegedAccessScheduleRequest();
        break;
