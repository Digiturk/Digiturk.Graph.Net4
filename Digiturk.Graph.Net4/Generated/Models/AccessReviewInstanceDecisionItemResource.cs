...
#nullable restore
        ...
        public static AccessReviewInstanceDecisionItemResource CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            ...
            if(mappingValue == "#microsoft.graph.accessReviewInstanceDecisionItemAccessPackageAssignmentPolicyResource")
            {
                return new AccessReviewInstanceDecisionItemAccessPackageAssignmentPolicyResource();
            }
            else if(mappingValue == "#microsoft.graph.accessReviewInstanceDecisionItemAzureRoleResource")
            {
                return new AccessReviewInstanceDecisionItemAzureRoleResource();
            }
            else if(mappingValue == "#microsoft.graph.accessReviewInstanceDecisionItemServicePrincipalResource")
            {
