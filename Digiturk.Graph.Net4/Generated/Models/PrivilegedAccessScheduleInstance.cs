...
PrivilegedAccessScheduleInstance result;
switch (mappingValue)
{
    case "#microsoft.graph.privilegedAccessGroupAssignmentScheduleInstance":
        result = new PrivilegedAccessGroupAssignmentScheduleInstance();
        break;
    case "#microsoft.graph.privilegedAccessGroupEligibilityScheduleInstance":
        result = new PrivilegedAccessGroupEligibilityScheduleInstance();
        break;
    default:
        result = new PrivilegedAccessScheduleInstance();
        break;
}
return result;
