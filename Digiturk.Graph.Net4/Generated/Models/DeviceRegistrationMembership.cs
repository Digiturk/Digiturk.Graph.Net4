...
#nullable restore
        ...
        public static DeviceRegistrationMembership CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            ...
            DeviceRegistrationMembership result;
switch (mappingValue)
{
    case "#microsoft.graph.allDeviceRegistrationMembership":
        result = new AllDeviceRegistrationMembership();
        break;
    case "#microsoft.graph.enumeratedDeviceRegistrationMembership":
        result = new EnumeratedDeviceRegistrationMembership();
        break;
    case "#microsoft.graph.noDeviceRegistrationMembership":
        result = new NoDeviceRegistrationMembership();
        break;
    default:
        result = new DeviceRegistrationMembership();
        break;
}
return result;
